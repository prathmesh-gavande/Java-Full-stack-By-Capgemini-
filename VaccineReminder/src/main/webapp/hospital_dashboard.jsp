...
<body>
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="add_child.jsp">
                        <i class="uil uil-user-plus"></i>
                        <span class="link-name">Add Child</span>
                    </a></li>
                <li><a href="view_children.jsp">
                        <i class="uil uil-users-alt"></i>
                        <span class="link-name">View Children</span>
                    </a></li>
                <li><a href="add_vaccineLog.jsp">
                        <i class="uil uil-file-plus"></i>
                        <span class="link-name">Add Vaccine Log</span>
                    </a></li>
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            ...
            <img height="650vh" width="1250vh" src="images/loginBackground.jpg" alt="">
            <div class="overview">
